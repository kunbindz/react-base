...
const Testimonials = () => (
  <section id='client' className={`${styles.paddingY} flexCenter flex-col relative `}>
    <div className=' absolute z-[0] w-[60%] h-[60%] -right-[50%] rounded-full blue__gradient '></div>
    <div className='w-full betweenCenter md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]'>
